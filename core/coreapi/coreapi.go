...
type CoreAPI struct {
	...
	chequeManger *mineservice.ChequeManager
...
// Cheque returns the ChequeApi interface implementation backed by the go-ipfs node
func (api *CoreAPI) Cheque() coreiface.ChequeAPI {
	return (*ChequeAPI)(api)
}

// Wallet returns the WalletAPI interface implementation backed by the go-ipfs node
func (api *CoreAPI) Wallet() coreiface.WalletAPI {
	return (*WalletAPI)(api)
}

// Chain returns the ChainAPI interface implementation backed by the go-ipfs node
func (api *CoreAPI) Chain() coreiface.ChainAPI {
	return (*ChainAPI)(api)
}
