...
require (
	...
	github.com/antnest-network/ant-proto v0.0.0-20211103102432-5f2eebb5d105
...
replace (
	github.com/ipfs/go-ipfs-config v0.14.0 => github.com/antnest-network/go-ant-config v0.0.0-20211115012827-07ee6f6e26f2
